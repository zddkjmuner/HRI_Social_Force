...
class Scenario(BaseScenario):
    ...
    def distance_between_agent(self, world):
        ...
        dist = 0
        for a in world.agents:
            agent_position = agent_position.append(a.state.p_pos)
    ...
    def reward(self, agent, world):
        ...
        beta1 = 5 # bigbig
        beta2 = 1
        rew1, rew2, rew3, rew4 = 0, 0, 0, 0
        for a in world.agents:
            rew1 += np.sum(a.state.p_vel**2) 
        ...
        if world.num_agents>1:        
            rew4 = self.distance_between_agent(world)
        ...
        return alpha*rew1 + beta1*rew2 + beta2*(rew3+rew4)
